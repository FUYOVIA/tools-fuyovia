              ...
              <div className="p-8">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-neutral-500 text-sm">
                    {authMode === 'signin'
                      ? 'Sign in to post, vote, and discuss'
                ...
                {/* Error */}
                {authError && (
                  <div className="mb-4 p-3 bg-red-50 rounded-xl border border-red-200/50 text-red-600 text-sm font-medium text-center">
                    {authError}
                  </div>
                )}
                ...
                <div className="space-y-3">
                  {authMode === 'signup' && (
                    <div>
                      <label className="block text-xs font-bold text-neutral-500 mb-1.5 uppercase tracking-wider">Display Name</label>
                  ...
                  <div>
                    ...
                    <input type="password" value={password} onChange={(e) => setPassword(e.target.value)}
                      ...
                      minLength={6} className="input-field text-sm" />
                  </div>

                  <button
                    onClick={handleEmailAuth}
                    disabled={!email.trim() || !password.trim() || (authMode === 'signup' && !displayName.trim()) || authLoading2}
                    className="w-full btn-primary py-3 px-6 rounded-2xl font-semibold disabled:opacity-50 mt-2"
                  >
                    {authLoading2
                ...
                <div className="flex items-center gap-3 my-5">
                  ...
                  <span className="text-xs text-neutral-400 font-medium uppercase">or</span>
                  <div className="flex-1 h-px bg-neutral-200" />
                </div>

                {/* Social Login (optional - requires OAuth config) */}
                <div className="space-y-2.5">
                  <button onClick={() => { signInWithGoogle(); closeLoginModal() }}
                    className="w-full flex items-center justify-center gap-3 py-2.5 px-6 rounded-xl border-2 border-neutral-200 bg-white font-medium text-neutral-600 hover:bg-neutral-50 transition-all text-sm">
                ...
                <p className="mt-5 text-center text-sm text-neutral-500">
                  {authMode === 'signin' ? (
                    <>Don&apos;t have an account?{' '}
                      <button onClick={() => { setAuthMode('signup'); setAuthError(null) }} className="text-primary-600 font-semibold hover:text-primary-700">
                        Sign up free
                      </button></>
                  ) : (
                    <>Already have an account?{' '}
                      <button onClick={() => { setAuthMode('signin'); setAuthError(null) }} className="text-primary-600 font-semibold hover:text-primary-700">
                        Sign in
                      </button></>
                  )}
                </p>
